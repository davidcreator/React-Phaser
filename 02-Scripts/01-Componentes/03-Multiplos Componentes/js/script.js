 ...
 * Lesson: 03 - Multiplos Componentes
 * How to use:
...
export class Example01Componentes03MultiplosComponentesScene extends Phaser.Scene {
  constructor() {
    super('01-componentes-03-multiplos-componentes')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '03 - Multiplos Componentes', { fontSize: '18px', color: '#ffffff' })
...
export function createExample01Componentes03MultiplosComponentesSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example01Componentes03MultiplosComponentesScene],
  }
}
