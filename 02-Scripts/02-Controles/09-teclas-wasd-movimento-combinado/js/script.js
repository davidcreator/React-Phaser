 ...
 * Category: controles
 * Lesson: 09 - teclas-wasd-movimento-combinado
 * How to use:
...
export class Example02Controles09TeclasWasdMovimentoCombinadoScene extends Phaser.Scene {
  constructor() {
    super('02-controles-09-teclas-wasd-movimento-combinado')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '09 - teclas-wasd-movimento-combinado', { fontSize: '18px', color: '#ffffff' })
...
export function createExample02Controles09TeclasWasdMovimentoCombinadoSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example02Controles09TeclasWasdMovimentoCombinadoScene],
  }
}
