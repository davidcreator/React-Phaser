...
export class Example05Hud01AventuraScene extends Phaser.Scene {
  constructor() {
    super('05-hud-01-aventura')
  }
  create() {
...
export function createExample05Hud01AventuraSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example05Hud01AventuraScene],
  }
}
