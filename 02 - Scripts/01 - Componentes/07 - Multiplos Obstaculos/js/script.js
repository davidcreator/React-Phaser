 ...
 * Lesson: 07 - Multiplos Obstaculos
 * How to use:
...
export class Example01Componentes07MultiplosObstaculosScene extends Phaser.Scene {
  constructor() {
    super('01-componentes-07-multiplos-obstaculos')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '07 - Multiplos Obstaculos', { fontSize: '18px', color: '#ffffff' })
...
export function createExample01Componentes07MultiplosObstaculosSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example01Componentes07MultiplosObstaculosScene],
  }
}
