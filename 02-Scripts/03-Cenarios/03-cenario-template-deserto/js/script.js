 ...
 * Category: cenarios
 * Lesson: 03 - cenario-template-deserto
 * How to use:
...
export class Example03Cenarios03CenarioTemplateDesertoScene extends Phaser.Scene {
  constructor() {
    super('03-cenarios-03-cenario-template-deserto')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '03 - cenario-template-deserto', { fontSize: '18px', color: '#ffffff' })
...
export function createExample03Cenarios03CenarioTemplateDesertoSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example03Cenarios03CenarioTemplateDesertoScene],
  }
}
