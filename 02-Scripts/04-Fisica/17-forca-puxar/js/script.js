...
export class Example04Fisica17ForcaPuxarScene extends Phaser.Scene {
  constructor() {
    super('04-fisica-17-forca-puxar')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '17 - forca-puxar', { fontSize: '18px', color: '#ffffff' })
...
export function createExample04Fisica17ForcaPuxarSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example04Fisica17ForcaPuxarScene],
  }
}
