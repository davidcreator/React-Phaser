...
export class Example04Fisica03GravidadePlanetasScene extends Phaser.Scene {
  constructor() {
    super('04-fisica-03-gravidade-planetas')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '03 - gravidade-planetas', { fontSize: '18px', color: '#ffffff' })
...
export function createExample04Fisica03GravidadePlanetasSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example04Fisica03GravidadePlanetasScene],
  }
}
