 ...
 * Category: fisica
 * Lesson: 04 - veiculos-carro-bicicleta
 * How to use:
...
export class Example04Fisica04VeiculosCarroBicicletaScene extends Phaser.Scene {
  constructor() {
    super('04-fisica-04-veiculos-carro-bicicleta')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '04 - veiculos-carro-bicicleta', { fontSize: '18px', color: '#ffffff' })
...
export function createExample04Fisica04VeiculosCarroBicicletaSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example04Fisica04VeiculosCarroBicicletaScene],
  }
}
