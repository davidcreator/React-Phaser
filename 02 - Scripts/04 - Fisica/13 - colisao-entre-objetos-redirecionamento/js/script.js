 ...
 * Category: fisica
 * Lesson: 13 - colisao-entre-objetos-redirecionamento
 * How to use:
...
export class Example04Fisica13ColisaoEntreObjetosRedirecionamentoScene extends Phaser.Scene {
  constructor() {
    super('04-fisica-13-colisao-entre-objetos-redirecionamento')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '13 - colisao-entre-objetos-redirecionamento', { fontSize: '18px', color: '#ffffff' })
...
export function createExample04Fisica13ColisaoEntreObjetosRedirecionamentoSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example04Fisica13ColisaoEntreObjetosRedirecionamentoScene],
  }
}
