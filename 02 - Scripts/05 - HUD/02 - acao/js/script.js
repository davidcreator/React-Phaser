...
export class Example05Hud02AcaoScene extends Phaser.Scene {
  constructor() {
    super('05-hud-02-acao')
  }
  create() {
...
export function createExample05Hud02AcaoSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
