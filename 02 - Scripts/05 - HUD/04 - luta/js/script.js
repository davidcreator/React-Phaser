...
export class Example05Hud04LutaScene extends Phaser.Scene {
  constructor() {
    super('05-hud-04-luta')
  }
  create() {
...
export function createExample05Hud04LutaSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
