 ...
 * Category: fisica
 * Lesson: 12 - colisao-entre-objetos
 * How to use:
...
export class Example04Fisica12ColisaoEntreObjetosScene extends Phaser.Scene {
  constructor() {
    super('04-fisica-12-colisao-entre-objetos')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '12 - colisao-entre-objetos', { fontSize: '18px', color: '#ffffff' })
...
export function createExample04Fisica12ColisaoEntreObjetosSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example04Fisica12ColisaoEntreObjetosScene],
  }
}
