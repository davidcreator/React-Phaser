 ...
 * Category: cenarios
 * Lesson: 06 - plano-de-fundo-com-troca-de-imagem
 * How to use:
...
export class Example03Cenarios06PlanoDeFundoComTrocaDeImagemScene extends Phaser.Scene {
  constructor() {
    super('03-cenarios-06-plano-de-fundo-com-troca-de-imagem')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '06 - plano-de-fundo-com-troca-de-imagem', { fontSize: '18px', color: '#ffffff' })
...
export function createExample03Cenarios06PlanoDeFundoComTrocaDeImagemSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example03Cenarios06PlanoDeFundoComTrocaDeImagemScene],
  }
}
