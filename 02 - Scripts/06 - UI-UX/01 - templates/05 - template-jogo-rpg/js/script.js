...
export class Example06UiUx05TemplateJogoRpgScene extends Phaser.Scene {
  constructor() {
    super('06-ui-ux-05-template-jogo-rpg')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.title = this.add.text(W / 2, 90, '05 - template-jogo-rpg', {
      fontSize: '34px',
      color: '#ffffff',
      fontStyle: 'bold',
    }).setOrigin(0.5)
...
export function createExample06UiUx05TemplateJogoRpgSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example06UiUx05TemplateJogoRpgScene],
  }
}
