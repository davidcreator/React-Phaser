...
export class Example04Fisica06BouncingQuicarScene extends Phaser.Scene {
  constructor() {
    super('04-fisica-06-bouncing-quicar')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '06 - bouncing-quicar', { fontSize: '18px', color: '#ffffff' })
...
export function createExample04Fisica06BouncingQuicarSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example04Fisica06BouncingQuicarScene],
  }
}
