...
export class Example05Hud03ArcadeScene extends Phaser.Scene {
  constructor() {
    super('05-hud-03-arcade')
  }
  create() {
...
export function createExample05Hud03ArcadeSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example05Hud03ArcadeScene],
  }
}
