 ...
 * Category: hud
 * Lesson: 09 - hud-aventura-usando-imagem-v2
 * How to use:
...
export class Example05Hud09HudAventuraUsandoImagemV2Scene extends Phaser.Scene {
  constructor() {
    super('05-hud-09-hud-aventura-usando-imagem-v2')
  }
  create() {
...
export function createExample05Hud09HudAventuraUsandoImagemV2SceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example05Hud09HudAventuraUsandoImagemV2Scene],
  }
}
