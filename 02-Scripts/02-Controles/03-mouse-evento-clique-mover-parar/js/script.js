 ...
 * Category: controles
 * Lesson: 03 - mouse-evento-clique-mover-parar
 * How to use:
...
export class Example02Controles03MouseEventoCliqueMoverPararScene extends Phaser.Scene {
  constructor() {
    super('02-controles-03-mouse-evento-clique-mover-parar')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '03 - mouse-evento-clique-mover-parar', { fontSize: '18px', color: '#ffffff' })
...
export function createExample02Controles03MouseEventoCliqueMoverPararSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example02Controles03MouseEventoCliqueMoverPararScene],
  }
}
