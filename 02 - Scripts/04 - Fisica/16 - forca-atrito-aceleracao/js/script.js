 ...
 * Category: fisica
 * Lesson: 16 - forca-atrito-aceleracao
 * How to use:
...
export class Example04Fisica16ForcaAtritoAceleracaoScene extends Phaser.Scene {
  constructor() {
    super('04-fisica-16-forca-atrito-aceleracao')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '16 - forca-atrito-aceleracao', { fontSize: '18px', color: '#ffffff' })
...
export function createExample04Fisica16ForcaAtritoAceleracaoSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example04Fisica16ForcaAtritoAceleracaoScene],
  }
}
