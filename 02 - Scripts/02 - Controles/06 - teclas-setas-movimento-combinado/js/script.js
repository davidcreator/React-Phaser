 ...
 * Category: controles
 * Lesson: 06 - teclas-setas-movimento-combinado
 * How to use:
...
export class Example02Controles06TeclasSetasMovimentoCombinadoScene extends Phaser.Scene {
  constructor() {
    super('02-controles-06-teclas-setas-movimento-combinado')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '06 - teclas-setas-movimento-combinado', { fontSize: '18px', color: '#ffffff' })
...
export function createExample02Controles06TeclasSetasMovimentoCombinadoSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example02Controles06TeclasSetasMovimentoCombinadoScene],
  }
}
