...
export class Example01Componentes06ObstaculosScene extends Phaser.Scene {
  constructor() {
    super('01-componentes-06-obstaculos')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '06 - Obstaculos', { fontSize: '18px', color: '#ffffff' })
...
export function createExample01Componentes06ObstaculosSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example01Componentes06ObstaculosScene],
  }
}
