 ...
 * Category: hud
 * Lesson: 11 - hud-arcade-usando-imagem
 * How to use:
...
export class Example05Hud11HudArcadeUsandoImagemScene extends Phaser.Scene {
  constructor() {
    super('05-hud-11-hud-arcade-usando-imagem')
  }
  create() {
...
export function createExample05Hud11HudArcadeUsandoImagemSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example05Hud11HudArcadeUsandoImagemScene],
  }
}
