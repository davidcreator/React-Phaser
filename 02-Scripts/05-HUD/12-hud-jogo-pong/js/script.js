...
export class Example05Hud12HudJogoPongScene extends Phaser.Scene {
  constructor() {
    super('05-hud-12-hud-jogo-pong')
  }
  create() {
...
export function createExample05Hud12HudJogoPongSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example05Hud12HudJogoPongScene],
  }
}
