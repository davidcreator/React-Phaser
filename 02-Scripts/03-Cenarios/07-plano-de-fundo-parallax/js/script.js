 ...
 * Category: cenarios
 * Lesson: 07 - plano-de-fundo-parallax
 * How to use:
...
export class Example03Cenarios07PlanoDeFundoParallaxScene extends Phaser.Scene {
  constructor() {
    super('03-cenarios-07-plano-de-fundo-parallax')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '07 - plano-de-fundo-parallax', { fontSize: '18px', color: '#ffffff' })
...
export function createExample03Cenarios07PlanoDeFundoParallaxSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example03Cenarios07PlanoDeFundoParallaxScene],
  }
}
