 ...
 * Category: cenarios
 * Lesson: 02 - cenario-template-floresta
 * How to use:
...
export class Example03Cenarios02CenarioTemplateFlorestaScene extends Phaser.Scene {
  constructor() {
    super('03-cenarios-02-cenario-template-floresta')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '02 - cenario-template-floresta', { fontSize: '18px', color: '#ffffff' })
...
export function createExample03Cenarios02CenarioTemplateFlorestaSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example03Cenarios02CenarioTemplateFlorestaScene],
  }
}
