 ...
 * Category: hud
 * Lesson: 06 - rpg-role-playing-game
 * How to use:
...
export class Example05Hud06RpgRolePlayingGameScene extends Phaser.Scene {
  constructor() {
    super('05-hud-06-rpg-role-playing-game')
  }
  create() {
...
export function createExample05Hud06RpgRolePlayingGameSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example05Hud06RpgRolePlayingGameScene],
  }
}
