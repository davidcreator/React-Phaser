 ...
 * Category: controles
 * Lesson: 08 - teclas-wasd-movimento-rotacao
 * How to use:
...
export class Example02Controles08TeclasWasdMovimentoRotacaoScene extends Phaser.Scene {
  constructor() {
    super('02-controles-08-teclas-wasd-movimento-rotacao')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '08 - teclas-wasd-movimento-rotacao', { fontSize: '18px', color: '#ffffff' })
...
export function createExample02Controles08TeclasWasdMovimentoRotacaoSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example02Controles08TeclasWasdMovimentoRotacaoScene],
  }
}
