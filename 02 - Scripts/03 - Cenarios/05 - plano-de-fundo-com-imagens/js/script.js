 ...
 * Category: cenarios
 * Lesson: 05 - plano-de-fundo-com-imagens
 * How to use:
...
export class Example03Cenarios05PlanoDeFundoComImagensScene extends Phaser.Scene {
  constructor() {
    super('03-cenarios-05-plano-de-fundo-com-imagens')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '05 - plano-de-fundo-com-imagens', { fontSize: '18px', color: '#ffffff' })
...
export function createExample03Cenarios05PlanoDeFundoComImagensSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example03Cenarios05PlanoDeFundoComImagensScene],
  }
}
