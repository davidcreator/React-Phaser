 ...
 * Category: fisica
 * Lesson: 09 - bouncing-com-colisao
 * How to use:
...
export class Example04Fisica09BouncingComColisaoScene extends Phaser.Scene {
  constructor() {
    super('04-fisica-09-bouncing-com-colisao')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '09 - bouncing-com-colisao', { fontSize: '18px', color: '#ffffff' })
...
export function createExample04Fisica09BouncingComColisaoSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example04Fisica09BouncingComColisaoScene],
  }
}
