 ...
 * Category: controles
 * Lesson: 02 - mouse-evento-clique-mover
 * How to use:
...
export class Example02Controles02MouseEventoCliqueMoverScene extends Phaser.Scene {
  constructor() {
    super('02-controles-02-mouse-evento-clique-mover')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '02 - mouse-evento-clique-mover', { fontSize: '18px', color: '#ffffff' })
...
export function createExample02Controles02MouseEventoCliqueMoverSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example02Controles02MouseEventoCliqueMoverScene],
  }
}
