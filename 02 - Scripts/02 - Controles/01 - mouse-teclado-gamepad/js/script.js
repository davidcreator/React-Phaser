 ...
 * Category: controles
 * Lesson: 01 - mouse-teclado-gamepad
 * How to use:
...
export class Example02Controles01MouseTecladoGamepadScene extends Phaser.Scene {
  constructor() {
    super('02-controles-01-mouse-teclado-gamepad')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '01 - mouse-teclado-gamepad', { fontSize: '18px', color: '#ffffff' })
...
export function createExample02Controles01MouseTecladoGamepadSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example02Controles01MouseTecladoGamepadScene],
  }
}
