 ...
 * Category: fisica
 * Lesson: 07 - bouncing-multiplos-objetos
 * How to use:
...
export class Example04Fisica07BouncingMultiplosObjetosScene extends Phaser.Scene {
  constructor() {
    super('04-fisica-07-bouncing-multiplos-objetos')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '07 - bouncing-multiplos-objetos', { fontSize: '18px', color: '#ffffff' })
...
export function createExample04Fisica07BouncingMultiplosObjetosSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example04Fisica07BouncingMultiplosObjetosScene],
  }
}
