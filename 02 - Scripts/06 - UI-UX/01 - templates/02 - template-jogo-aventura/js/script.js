 ...
 * Category: ui-ux
 * Lesson: 02 - template-jogo-aventura
 * How to use:
...
export class Example06UiUx02TemplateJogoAventuraScene extends Phaser.Scene {
  constructor() {
    super('06-ui-ux-02-template-jogo-aventura')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.title = this.add.text(W / 2, 90, '02 - template-jogo-aventura', {
      fontSize: '34px',
      color: '#ffffff',
      fontStyle: 'bold',
    }).setOrigin(0.5)
...
export function createExample06UiUx02TemplateJogoAventuraSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example06UiUx02TemplateJogoAventuraScene],
  }
}
