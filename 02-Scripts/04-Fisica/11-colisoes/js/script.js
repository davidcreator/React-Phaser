...
export class Example04Fisica11ColisoesScene extends Phaser.Scene {
  constructor() {
    super('04-fisica-11-colisoes')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '11 - colisoes', { fontSize: '18px', color: '#ffffff' })
...
export function createExample04Fisica11ColisoesSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example04Fisica11ColisoesScene],
  }
}
