 ...
 * Category: controles
 * Lesson: 12 - controlado-por-maquina-multiplos-objetos
 * How to use:
...
export class Example02Controles12ControladoPorMaquinaMultiplosObjetosScene extends Phaser.Scene {
  constructor() {
    super('02-controles-12-controlado-por-maquina-multiplos-objetos')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '12 - controlado-por-maquina-multiplos-objetos', { fontSize: '18px', color: '#ffffff' })
...
export function createExample02Controles12ControladoPorMaquinaMultiplosObjetosSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example02Controles12ControladoPorMaquinaMultiplosObjetosScene],
  }
}
