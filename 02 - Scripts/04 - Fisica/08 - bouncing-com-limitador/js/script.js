 ...
 * Category: fisica
 * Lesson: 08 - bouncing-com-limitador
 * How to use:
...
export class Example04Fisica08BouncingComLimitadorScene extends Phaser.Scene {
  constructor() {
    super('04-fisica-08-bouncing-com-limitador')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '08 - bouncing-com-limitador', { fontSize: '18px', color: '#ffffff' })
...
export function createExample04Fisica08BouncingComLimitadorSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example04Fisica08BouncingComLimitadorScene],
  }
}
