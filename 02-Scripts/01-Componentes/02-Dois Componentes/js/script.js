...
export class Example01Componentes02DoisComponentesScene extends Phaser.Scene {
  constructor() {
    super('01-componentes-02-dois-componentes')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '02 - Dois Componentes', { fontSize: '18px', color: '#ffffff' })
...
export function createExample01Componentes02DoisComponentesSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example01Componentes02DoisComponentesScene],
  }
}
