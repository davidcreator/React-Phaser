 ...
 * Category: controles
 * Lesson: 10 - controlado-por-maquina
 * How to use:
...
export class Example02Controles10ControladoPorMaquinaScene extends Phaser.Scene {
  constructor() {
    super('02-controles-10-controlado-por-maquina')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '10 - controlado-por-maquina', { fontSize: '18px', color: '#ffffff' })
...
export function createExample02Controles10ControladoPorMaquinaSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example02Controles10ControladoPorMaquinaScene],
  }
}
