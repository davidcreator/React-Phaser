...
export class Example04Fisica01GravitacionalQuedaScene extends Phaser.Scene {
  constructor() {
    super('04-fisica-01-gravitacional-queda')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '01 - gravitacional-queda', { fontSize: '18px', color: '#ffffff' })
...
export function createExample04Fisica01GravitacionalQuedaSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example04Fisica01GravitacionalQuedaScene],
  }
}
