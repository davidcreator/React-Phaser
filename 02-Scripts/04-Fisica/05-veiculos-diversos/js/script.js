...
export class Example04Fisica05VeiculosDiversosScene extends Phaser.Scene {
  constructor() {
    super('04-fisica-05-veiculos-diversos')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '05 - veiculos-diversos', { fontSize: '18px', color: '#ffffff' })
...
export function createExample04Fisica05VeiculosDiversosSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example04Fisica05VeiculosDiversosScene],
  }
}
