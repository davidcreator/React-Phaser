...
export class Example02Controles04TeclasSetasScene extends Phaser.Scene {
  constructor() {
    super('02-controles-04-teclas-setas')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '04 - teclas-setas', { fontSize: '18px', color: '#ffffff' })
...
export function createExample02Controles04TeclasSetasSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example02Controles04TeclasSetasScene],
  }
}
