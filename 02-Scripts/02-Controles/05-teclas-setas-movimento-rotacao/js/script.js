 ...
 * Category: controles
 * Lesson: 05 - teclas-setas-movimento-rotacao
 * How to use:
...
export class Example02Controles05TeclasSetasMovimentoRotacaoScene extends Phaser.Scene {
  constructor() {
    super('02-controles-05-teclas-setas-movimento-rotacao')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '05 - teclas-setas-movimento-rotacao', { fontSize: '18px', color: '#ffffff' })
...
export function createExample02Controles05TeclasSetasMovimentoRotacaoSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example02Controles05TeclasSetasMovimentoRotacaoScene],
  }
}
