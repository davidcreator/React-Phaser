...
export class Example01Componentes05FormasPrimitivasScene extends Phaser.Scene {
  constructor() {
    super('01-componentes-05-formas-primitivas')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '05 - Formas Primitivas', { fontSize: '18px', color: '#ffffff' })
...
export function createExample01Componentes05FormasPrimitivasSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example01Componentes05FormasPrimitivasScene],
  }
}
