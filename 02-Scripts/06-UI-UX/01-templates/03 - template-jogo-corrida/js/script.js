 ...
 * Category: ui-ux
 * Lesson: 03 - template-jogo-corrida
 * How to use:
...
export class Example06UiUx03TemplateJogoCorridaScene extends Phaser.Scene {
  constructor() {
    super('06-ui-ux-03-template-jogo-corrida')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.title = this.add.text(W / 2, 90, '03 - template-jogo-corrida', {
      fontSize: '34px',
      color: '#ffffff',
      fontStyle: 'bold',
    }).setOrigin(0.5)
...
export function createExample06UiUx03TemplateJogoCorridaSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example06UiUx03TemplateJogoCorridaScene],
  }
}
