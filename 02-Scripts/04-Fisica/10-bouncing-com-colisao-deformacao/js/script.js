 ...
 * Category: fisica
 * Lesson: 10 - bouncing-com-colisao-deformacao
 * How to use:
...
export class Example04Fisica10BouncingComColisaoDeformacaoScene extends Phaser.Scene {
  constructor() {
    super('04-fisica-10-bouncing-com-colisao-deformacao')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '10 - bouncing-com-colisao-deformacao', { fontSize: '18px', color: '#ffffff' })
...
export function createExample04Fisica10BouncingComColisaoDeformacaoSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example04Fisica10BouncingComColisaoDeformacaoScene],
  }
}
