 ...
 * Category: hud
 * Lesson: 07 - fps-first-person-shooter
 * How to use:
...
export class Example05Hud07FpsFirstPersonShooterScene extends Phaser.Scene {
  constructor() {
    super('05-hud-07-fps-first-person-shooter')
  }
  create() {
...
export function createExample05Hud07FpsFirstPersonShooterSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example05Hud07FpsFirstPersonShooterScene],
  }
}
