...
export class Example06UiUx01TemplateJogoAcaoScene extends Phaser.Scene {
  constructor() {
    super('06-ui-ux-01-template-jogo-acao')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.title = this.add.text(W / 2, 90, '01 - template-jogo-acao', {
      fontSize: '34px',
      color: '#ffffff',
      fontStyle: 'bold',
    }).setOrigin(0.5)
...
export function createExample06UiUx01TemplateJogoAcaoSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example06UiUx01TemplateJogoAcaoScene],
  }
}
