 ...
 * Category: cenarios
 * Lesson: 04 - cenario-template-deserto-de-gelo
 * How to use:
...
export class Example03Cenarios04CenarioTemplateDesertoDeGeloScene extends Phaser.Scene {
  constructor() {
    super('03-cenarios-04-cenario-template-deserto-de-gelo')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '04 - cenario-template-deserto-de-gelo', { fontSize: '18px', color: '#ffffff' })
...
export function createExample03Cenarios04CenarioTemplateDesertoDeGeloSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example03Cenarios04CenarioTemplateDesertoDeGeloScene],
  }
}
