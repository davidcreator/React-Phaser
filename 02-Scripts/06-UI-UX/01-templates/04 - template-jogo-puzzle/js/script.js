 ...
 * Category: ui-ux
 * Lesson: 04 - template-jogo-puzzle
 * How to use:
...
export class Example06UiUx04TemplateJogoPuzzleScene extends Phaser.Scene {
  constructor() {
    super('06-ui-ux-04-template-jogo-puzzle')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.title = this.add.text(W / 2, 90, '04 - template-jogo-puzzle', {
      fontSize: '34px',
      color: '#ffffff',
      fontStyle: 'bold',
    }).setOrigin(0.5)
...
export function createExample06UiUx04TemplateJogoPuzzleSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example06UiUx04TemplateJogoPuzzleScene],
  }
}
