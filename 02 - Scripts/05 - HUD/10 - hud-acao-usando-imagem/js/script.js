 ...
 * Category: hud
 * Lesson: 10 - hud-acao-usando-imagem
 * How to use:
...
export class Example05Hud10HudAcaoUsandoImagemScene extends Phaser.Scene {
  constructor() {
    super('05-hud-10-hud-acao-usando-imagem')
  }
  create() {
...
export function createExample05Hud10HudAcaoUsandoImagemSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example05Hud10HudAcaoUsandoImagemScene],
  }
}
