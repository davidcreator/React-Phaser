...
export class Example05Hud05CorridaScene extends Phaser.Scene {
  constructor() {
    super('05-hud-05-corrida')
  }
  create() {
...
export function createExample05Hud05CorridaSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example05Hud05CorridaScene],
  }
}
