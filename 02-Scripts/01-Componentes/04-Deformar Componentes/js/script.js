 ...
 * Lesson: 04 - Deformar Componentes
 * How to use:
...
export class Example01Componentes04DeformarComponentesScene extends Phaser.Scene {
  constructor() {
    super('01-componentes-04-deformar-componentes')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '04 - Deformar Componentes', { fontSize: '18px', color: '#ffffff' })
...
export function createExample01Componentes04DeformarComponentesSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example01Componentes04DeformarComponentesScene],
  }
}
