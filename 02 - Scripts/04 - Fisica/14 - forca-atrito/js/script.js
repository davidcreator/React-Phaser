...
export class Example04Fisica14ForcaAtritoScene extends Phaser.Scene {
  constructor() {
    super('04-fisica-14-forca-atrito')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '14 - forca-atrito', { fontSize: '18px', color: '#ffffff' })
...
export function createExample04Fisica14ForcaAtritoSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example04Fisica14ForcaAtritoScene],
  }
}
