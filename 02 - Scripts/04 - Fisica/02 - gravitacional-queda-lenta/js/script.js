 ...
 * Category: fisica
 * Lesson: 02 - gravitacional-queda-lenta
 * How to use:
...
export class Example04Fisica02GravitacionalQuedaLentaScene extends Phaser.Scene {
  constructor() {
    super('04-fisica-02-gravitacional-queda-lenta')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '02 - gravitacional-queda-lenta', { fontSize: '18px', color: '#ffffff' })
...
export function createExample04Fisica02GravitacionalQuedaLentaSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example04Fisica02GravitacionalQuedaLentaScene],
  }
}
