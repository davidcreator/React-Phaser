...
export class Example02Controles07TeclasWasdScene extends Phaser.Scene {
  constructor() {
    super('02-controles-07-teclas-wasd')
  }
  create() {
    const { width: W, height: H } = this.cameras.main

    this.add.text(16, 12, '07 - teclas-wasd', { fontSize: '18px', color: '#ffffff' })
...
export function createExample02Controles07TeclasWasdSceneConfig(parent) {
  return {
    type: Phaser.AUTO,
    width: 960,
    height: 540,
    ...
    scene: [Example02Controles07TeclasWasdScene],
  }
}
